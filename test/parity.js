...
describe('parity of the hand assembled fixtures', function() {
  /*
      ...
      which ESC/POS counts in dots and StarPRNT in characters, the page of the
      four print directions, which both languages compose out of the same four
      print areas, and the five GS1 DataBar receipts, which both languages print
      from their own symbology number.
  */
  ...
  it('should have fixtures in both languages to compare', function() {
    assert.deepEqual(shared, [
      ...
      'international', 'margins', 'page-mode-directions', 'print-mode', 'tabs',
    ]);
  });
